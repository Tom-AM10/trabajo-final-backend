...
CREATE TABLE `teclados` (
  `id` int NOT NULL,
  `tipo_teclados` varchar(50) NOT NULL,
  `marca_teclado` varchar(50) NOT NULL,
  `productos_id` int NOT NULL,
  PRIMARY KEY (`id`,`productos_id`),
  KEY `fk_teclados_productos_idx` (`productos_id`),
  CONSTRAINT `fk_teclados_productos` FOREIGN KEY (`productos_id`) REFERENCES `productos` (`id`)
...
INSERT INTO `teclados` VALUES (1,'Mecanico','HyperX',2);
...
-- Dump completed on 2023-11-30 23:35:27
